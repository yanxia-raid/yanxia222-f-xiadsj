...
import { ensureTavernGreetingOnce } from "@/lib/tavern/session";
...
export function ChatRoom({ session, onBack }: ChatRoomProps) {
    ...
    useEffect(() => {
        ...
        // Tavern cards own their opening message. Seed it as a real assistant message
        // before the normal room initialization, while leaving ordinary characters untouched.
        ensureTavernGreetingOnce(session);
